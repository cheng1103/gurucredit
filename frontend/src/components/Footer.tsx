...
export function Footer() {
  ...
  return (
    <footer className="relative border-t border-border/60 bg-surface before:absolute before:inset-x-0 before:top-0 before:h-px before:bg-gradient-to-r before:from-transparent before:via-primary/30 before:to-transparent">
