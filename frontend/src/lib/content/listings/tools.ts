...
export const toolsIntro: { en: Intro; ms: Intro } = {
  ...
  ms: {
    paragraphs: [
      'Alat pinjaman GURU Credits memberi peminjam Malaysia cara pantas dan tanpa sebarang komitmen untuk memahami kedudukan kewangan anda sebelum menghantar sebarang permohonan. Alat Perbandingan Pinjaman menyusun kadar petunjuk, tempoh, dan anggaran ansuran bulanan daripada bank-bank utama Malaysia secara bersebelahan, supaya anda dapat lihat bagaimana pinjaman peribadi sebenarnya dibandingkan selepas yuran dan kadar efektif diambil kira, bukan sekadar kadar faedah utama. Ujian Kelayakan pula menyemak pendapatan, komitmen sedia ada, dan profil kredit anda untuk menganggarkan Nisbah Khidmat Hutang (DSR) anda serta menunjukkan gabungan jumlah dan tempoh pinjaman yang realistik untuk situasi anda, sebelum mana-mana bank menyemak fail anda.',
      'Kedua-dua alat ini dibina berdasarkan soalan yang sama yang sering ditanya peminjam: apa yang saya benar-benar layak, dan berapa kos sebenar setiap bulan? Gunakan alat perbandingan dahulu untuk senaraikan julat kadar, kemudian jalankan ujian kelayakan untuk sahkan pendapatan dan DSR anda menyokong senarai tersebut. Jika anda sedang membandingkan pinjaman tanpa cagaran, panduan pinjaman peribadi kami menerangkan terma biasa ditawarkan bank, dan pustaka panduan pinjaman kami meliputi CCRIS, CTOS, dan strategi penyatuan hutang dengan lebih mendalam.',
    ],
    links: [
