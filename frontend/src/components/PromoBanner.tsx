...
const promotions: Promotion[] = [
  {
    id: 'review-window-2026',
    type: 'limited-time',
    startDate: '2024-01-01',
    endDate: '2026-12-31',
    en: {
      title: 'Eligibility Review Window',
      description: 'Start with a written review, document checklist, and next-step guidance tailored to your profile.',
      cta: 'Start Quick Check',
    },
    ms: {
      title: 'Tetingkap Semakan Kelayakan',
      description: 'Mulakan dengan semakan bertulis, senarai dokumen, dan panduan langkah seterusnya mengikut profil anda.',
      cta: 'Mulakan Quick Check',
    },
  ...
  },
  {
    ...
    en: {
      ...
      description: 'Profiles submitted earlier in the day are prioritised for faster consultant follow-up during business hours.',
      cta: 'Get Reviewed',
    },
    ms: {
      title: 'Susulan Keutamaan',
      description: 'Profil yang dihantar lebih awal dalam hari akan diberi keutamaan untuk susulan perunding yang lebih pantas pada waktu pejabat.',
      cta: 'Mula Disemak',
    },
    link: '/eligibility-test',
