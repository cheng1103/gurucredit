export const aboutContent = {
  en: {
      ...
      items: [
        {
          ...
          description: 'We only collect essentials and store data securely.',
        },
        {
          title: 'No upfront payments',
          description: 'Eligibility fees are only collected via official WhatsApp after submission.',
        },
        {
          title: 'Transparent comparisons',
          description: 'We show effective costs, not just headline rates.',
        },
      ],
    },
    coverage: {
      ...
      items: [
        {
          ...
          description: 'Your personal and financial data is handled with the highest level of confidentiality. We comply with PDPA guidelines and use SSL encryption.',
        },
        {
          title: 'Transparency',
          description: 'No hidden fees or surprises. All rates, terms, and charges are clearly disclosed upfront before you commit.',
        },
        {
          title: 'Fast Service',
      ...
      items: [
        {
          ...
          description: 'Easy online application that takes just 5 minutes. Minimal documentation required.',
        },
        {
          title: 'Competitive Rates',
          description: 'Interest rates starting from 4.88% flat rate per annum. No hidden charges.',
        },
        {
          title: 'Fast Approval',
        ...
        },
        {
          ...
          description: 'Choose repayment tenure that suits your budget with fixed monthly installments.',
        },
      ],
    },
    services: {
    ...
    testimonials: {
      ...
      description: 'Real feedback from borrowers who have used our loan services.',
      items: [
        {
          name: 'Ahmad R.',
        ...
        },
        {
          ...
          text: 'Consolidated 5 different loans into one with GURU Credits. Now I save RM400 per month and have only one payment to manage.',
          rating: 5,
        },
      ],
    },
  ...
  ms: {
    ...
    trust: {
      badge: 'Kepercayaan & Pematuhan',
      title: 'Panduan yang Selamat & Disahkan',
      items: [
        {
          title: 'Pengendalian patuh PDPA',
          description: 'Kami hanya kumpul maklumat penting dan simpan dengan selamat.',
        },
        {
          title: 'Tiada bayaran awal',
          description: 'Yuran kelayakan hanya dikutip melalui WhatsApp rasmi selepas dihantar.',
        },
        {
          title: 'Perbandingan telus',
          description: 'Kami tunjuk kos sebenar, bukan sekadar kadar iklan.',
        },
      ],
    },
    coverage: {
    ...
    values: {
      badge: 'Apa Yang Kami Perjuangkan',
      ...
      items: [
        {
          title: 'Kepercayaan & Keselamatan',
          description: 'Data peribadi dan kewangan anda dikendalikan dengan tahap kerahsiaan tertinggi. Kami mematuhi garis panduan PDPA dan menggunakan penyulitan SSL.',
        },
        {
          title: 'Ketelusan',
          description: 'Tiada caj tersembunyi atau kejutan. Semua kadar, terma, dan caj dinyatakan dengan jelas sebelum anda komit.',
        },
        {
      ...
      items: [
        {
          ...
          description: 'Permohonan online yang mudah hanya mengambil 5 minit. Dokumentasi minimum diperlukan.',
        },
        {
        ...
        },
        {
          ...
          description: 'Pilih tempoh pembayaran yang sesuai dengan bajet anda dengan ansuran bulanan tetap.',
        },
      ],
    },
    services: {
      badge: 'Produk Pinjaman',
    ...
    testimonials: {
      ...
      description: 'Maklum balas sebenar dari peminjam yang telah menggunakan perkhidmatan pinjaman kami.',
      items: [
        {
          name: 'Ahmad R.',
          location: 'Kuala Lumpur',
        ...
        },
        {
          name: 'Raj K.',
          location: 'Johor Bahru',
          text: 'Menyatukan 5 pinjaman berbeza menjadi satu dengan GURU Credits. Kini saya jimat RM400 sebulan dan hanya ada satu bayaran untuk diuruskan.',
          rating: 5,
        },
      ],
    },
