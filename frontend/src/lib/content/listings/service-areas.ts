...
export const serviceAreasIntro: { en: Intro; ms: Intro } = {
  ...
  ms: {
    paragraphs: [
      'Halaman serantau ini menterjemahkan liputan pinjaman GURU Credits di seluruh Malaysia kepada konteks kemampuan yang sebenarnya berbeza mengikut negeri: pendapatan isi rumah median, harga hartanah biasa, dan julat DSR yang selesa digunakan lender di pasaran tersebut. Liputan meliputi semua 13 negeri dan 3 wilayah persekutuan, daripada siling DSR bandar yang lebih tinggi lazim di Kuala Lumpur dan Selangor kepada penanda aras lebih berhati-hati yang biasa di Sabah, Sarawak, dan negeri Pantai Timur. Setiap halaman turut menyenaraikan kepakaran bank dan corak peminjam tempatan yang paling kerap dilihat perunding kami di rantau tersebut.',
      'Di mana sahaja anda berada, proses semakan itu sendiri tidak berubah: kami tetap mengira DSR anda, menyemak fail CCRIS atau CTOS anda, dan memadankan anda dengan lender yang sesuai dengan pendapatan serta komitmen sedia ada. Gunakan halaman serantau ini untuk menetapkan jangkaan yang realistik sebelum memohon, kemudian jalankan ujian kelayakan untuk lihat kedudukan angka anda sendiri. Jika pinjaman peribadi adalah pilihan utama anda, panduan pinjaman peribadi kami menerangkan terma yang biasa ditawarkan kebanyakan bank Malaysia, dan pustaka panduan pinjaman kami meliputi skor kredit, CCRIS, dan topik penyatuan hutang dengan lebih mendalam.',
    ],
    links: [
